...
public class SC_MSFlyingEye : SC_RPGUnit
{
    [SerializeField] GameObject _skillObject;
    Transform skillPos;
    void Awake()
    {
        InitData(SC_PublicDefine.eUnitName.FlyingEye);
    ...
    public override void ChangeAniToAction(SC_PublicDefine.eActionState state)
    {
        switch (state)
        {
            ...
            case SC_PublicDefine.eActionState.ATTACK:
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.FlyingEyeAttack);
                _aniCtrl.SetTrigger("Attack");
                break;
            case SC_PublicDefine.eActionState.SKILL:
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.FlyingEyeSkill);
            ...
            case SC_PublicDefine.eActionState.DEAD:
                _isdead = true;
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.FlyingEyeDeath);
    ...
    public override void FindTime(int SelectAction)
    {
        ...
        {
            case 0:
                FindAniPlayTime("MSFlyingEye_ATTACK");
                break;
            case 2:
                FindAniPlayTime("MSFlyingEye_SKILL");
                break;
            default:
                AniPlayTime = 0.5f;
                break;

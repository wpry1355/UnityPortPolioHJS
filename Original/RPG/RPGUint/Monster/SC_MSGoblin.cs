...
public class SC_MSGoblin : SC_RPGUnit
{
    [SerializeField] GameObject _skillObject;
    Transform skillPos;
    void Awake()
    {
        InitData(SC_PublicDefine.eUnitName.Goblin);
    ...
    public override void ChangeAniToAction(SC_PublicDefine.eActionState state)
    {
        switch (state)
        {
            ...
            case SC_PublicDefine.eActionState.ATTACK:
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.GoblinAttack);
                _aniCtrl.SetTrigger("Attack");
                break;
            case SC_PublicDefine.eActionState.SKILL:
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.GoblinSkill);
            ...
            case SC_PublicDefine.eActionState.DEAD:
                _isdead = true;
                SC_SoundControlManager._instance.EffectSoundPlay(SC_PublicDefine.eSoundTrack.GoblinDeath);
    ...
    public override void FindTime(int SelectAction)
    {
        ...
        {
            case 0:
                FindAniPlayTime("MSGoblin_ATTACK");
                break;
            case 2:
                FindAniPlayTime("MSGoblin_SKILL");
                break;
            default:
                AniPlayTime = 0.5f;
                break;

...
public class SC_FireSpiritSkill : MonoBehaviour
{
    SC_RPGUnit parent;
    Animator _aniCtrl;
    Vector3 targetPos;
    ...
    void Awake()
    {
        ...
        targetPos = SC_RPGInGameManager._instance.PCUnitList[parent.targetArrNum].gameObject.transform.position + new Vector3( 0, 1.5f, 0);
    }

...
public class SC_MageSkill : MonoBehaviour
{
    SC_RPGUnit parent;
    Animator _aniCtrl;
    Vector3 targetPos;
    ...
    void Awake()
    {
        ...
        targetPos = SC_RPGInGameManager._instance.MSUnitList[parent.targetArrNum].gameObject.transform.position + new Vector3(0, 2, 0); ;
    }
